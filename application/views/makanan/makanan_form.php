  ...
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Form Makanan</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form action="<?php echo $action; ?>" method="post" enctype='multipart/form-data'>
        ...
        <div class="form-group">
            <label for="varchar">Nama Makanan<?php echo form_error('nama') ?></label>
            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?php echo $nama; ?>" required  />
        </div>
        <div class="form-group">
            <label for="int">Harga <?php echo form_error('harga') ?></label>
            <input type="number" class="form-control" name="harga" id="harga" min="1000" placeholder="Rp .." value="<?php echo $harga; ?>" required  />
        </div>
        <div class="form-group">
            <label>Stock</label>
