...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Pendaftar Warung</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          # code...
                foreach ($warung_data as $warung)
                {
                  ...
                  <tr>
                   ...
                   <td><?php echo $warung->namawarung ?></td>
                   <td><?php echo $warung->lamasewa ?> Tahun</td>
                   <td><?php echo $warung->keterangan ?></td>
                   <td>
                    <!-- <button class="btn btn-sm btn-info lht_minum" data-id=""><i class="fas fa-eye"></i></button> -->
                    <a class="btn btn-sm btn-success" href="<?= site_url('warung/verif/'.$warung->idpendaftaran) ?>" onclick="return confirm('Verifikasi Warung Ini ?')"><i class="fas fa-check-circle"></i></a>
                    <a class="btn btn-sm btn-danger" href="<?= site_url('warung/deletependaftar/'.$warung->idpendaftaran) ?>" onclick="return confirm('Hapus Item Ini ?')"><i class="fas fa-times-circle"></i></a>
                  </td>
                </tr>
                <?php 
              }
